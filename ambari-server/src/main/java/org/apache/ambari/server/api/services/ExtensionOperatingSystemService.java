 ...
 */
public class ExtensionOperatingSystemService extends BaseService {
   ...
   */
  public ExtensionOperatingSystemService(Map<Resource.Type, String> parentKeyProperties) {
  ...
  public ExtensionRepositoryService getOperatingSystemsHandler(@PathParam("osType") String osType) {
    final Map<Resource.Type, String> mapIds = new HashMap<Resource.Type, String>();
    mapIds.putAll(parentKeyProperties);
    mapIds.put(Resource.Type.ExtensionOperatingSystem, osType);
    return new ExtensionRepositoryService(mapIds);
  }
  ...
  private ResourceInstance createResource(String osType) {
    ...
    mapIds.putAll(parentKeyProperties);
    mapIds.put(Resource.Type.ExtensionOperatingSystem, osType);
    return createResource(Resource.Type.ExtensionOperatingSystem, mapIds);
  }
}
