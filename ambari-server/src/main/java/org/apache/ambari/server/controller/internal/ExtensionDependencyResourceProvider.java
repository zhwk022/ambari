...
/**
 * Resource provider for Extension Dependency resource.
 */
public class ExtensionDependencyResourceProvider extends AbstractResourceProvider {

  // ----- Property ID constants ---------------------------------------------

  protected static final String EXTENSION_NAME_ID =
      PropertyHelper.getPropertyId("Dependencies", "extension_name");
  protected static final String EXTENSION_VERSION_ID =
      PropertyHelper.getPropertyId("Dependencies", "extension_version");
   ...
   */
  protected ExtensionDependencyResourceProvider(Set<String> propertyIds,
  ...
  public RequestStatus createResources(Request request)
    ...
    throw new SystemException("Extension resources are read only");
  }
  ...
  private Collection<Resource> getDependencyResources(Map<String, Object> properties, Set<String> requestedIds)
    ...
    final String extensionName = (String) properties.get(EXTENSION_NAME_ID);
    final String version = (String) properties.get(EXTENSION_VERSION_ID);
    ...
    if (dependencyName != null) {
      dependencies.add(getResources(new Command<DependencyInfo>() {
        ...
        public DependencyInfo invoke() throws AmbariException {
          return ambariMetaInfo.getExtensionComponentDependency(extensionName, version, dependentService,
      ...
      dependencies.addAll(getResources(new Command<List<DependencyInfo>>() {
        ...
        public List<DependencyInfo> invoke() throws AmbariException {
          return ambariMetaInfo.getExtensionComponentDependencies(extensionName, version,
    ...
    for (DependencyInfo dependency : dependencies) {
      if (dependency != null) {
        resources.add(toResource(dependency, extensionName, version, dependentService,
   ...
   */
  private Resource toResource(DependencyInfo dependency, String extensionName,
                              String version, String dependentService,
                              String dependentComponent, Set<String> requestedIds) {

    Resource resource = new ResourceImpl(Resource.Type.ExtensionServiceComponentDependency);
    ...
    setResourceProperty(resource, EXTENSION_NAME_ID, extensionName, requestedIds);
    setResourceProperty(resource, EXTENSION_VERSION_ID, version, requestedIds);
