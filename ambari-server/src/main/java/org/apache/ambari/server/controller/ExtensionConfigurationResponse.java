...
public class ExtensionConfigurationResponse {
  ...
  public ExtensionConfigurationResponse(PropertyInfo info) {
   ...
   */
  public ExtensionConfigurationResponse(String propertyName, String propertyValue, String propertyDescription,
  ...
  /**
   * Extension configuration response with all properties.
   * @param propertyName Property Key
   * @param propertyValue Property Value
   * @param propertyDescription Property Description
   * @param type Configuration type
   ...
   */
  public ExtensionConfigurationResponse(String propertyName, String propertyValue,
  ...
  /**
   * Get type of property as set in the extension definition.
