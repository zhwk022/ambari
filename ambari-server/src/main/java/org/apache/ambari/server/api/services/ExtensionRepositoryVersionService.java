 ...
 */
public class ExtensionRepositoryVersionService extends BaseService {
   ...
   */
  public ExtensionRepositoryVersionService(Map<Resource.Type, String> parentKeyProperties) {
  ...
  public ExtensionOperatingSystemService getOperatingSystemsHandler(@PathParam("repositoryVersionId") String repositoryVersionId) {
    ...
    mapIds.put(Resource.Type.ExtensionRepositoryVersion, repositoryVersionId);
  ...
  private ResourceInstance createResource(String repositoryVersionId) {
    ...
    mapIds.putAll(parentKeyProperties);
    mapIds.put(Resource.Type.ExtensionRepositoryVersion, repositoryVersionId);
    return createResource(Resource.Type.ExtensionRepositoryVersion, mapIds);
  }
}
