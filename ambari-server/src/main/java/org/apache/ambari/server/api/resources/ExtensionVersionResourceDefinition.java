...
public class ExtensionVersionResourceDefinition extends BaseResourceDefinition {
  ...
  public Set<SubResourceDefinition> getSubResourceDefinitions() {
    ...
    children.add(new SubResourceDefinition(Resource.Type.ExtensionService));
    children.add(new SubResourceDefinition(Resource.Type.ExtensionLevelConfiguration));
    children.add(new SubResourceDefinition(Resource.Type.RepositoryVersion));
    children.add(new SubResourceDefinition(Resource.Type.ExtensionArtifact));
