...
public class ExtensionConfigurationResourceProvider extends
  ...
  public Set<Resource> getResources(Request request, Predicate predicate)
    ...
    final Set<ExtensionConfigurationRequest> requests = new HashSet<ExtensionConfigurationRequest>();
    ...
    Set<ExtensionConfigurationResponse> responses = getResources(new Command<Set<ExtensionConfigurationResponse>>() {
      ...
      public Set<ExtensionConfigurationResponse> invoke() throws AmbariException {
        return getManagementController().getExtensionConfigurations(requests);
      }
    });
    ...
    for (ExtensionConfigurationResponse response : responses) {
      Resource resource = new ResourceImpl(Resource.Type.ExtensionConfiguration);
      ...
      for (Map.Entry<String, String> attribute : response.getPropertyAttributes().entrySet()) {
        setResourceProperty(resource, PropertyHelper.getPropertyId("ExtensionConfigurations", attribute.getKey()),
  ...
  private ExtensionConfigurationRequest getRequest(Map<String, Object> properties) {
    return new ExtensionConfigurationRequest(
