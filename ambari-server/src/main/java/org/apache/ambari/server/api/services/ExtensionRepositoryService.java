 ...
 */
public class ExtensionRepositoryService extends BaseService {
   ...
   */
  public ExtensionRepositoryService(Map<Resource.Type, String> parentKeyProperties) {
  ...
  private ResourceInstance createResource(String repoId) {
    ...
    mapIds.put(Resource.Type.ExtensionRepository, repoId);
    return createResource(Resource.Type.ExtensionRepository, mapIds);
  }
}
