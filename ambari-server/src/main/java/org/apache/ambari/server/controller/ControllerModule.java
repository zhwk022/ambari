...
import org.apache.ambari.server.controller.internal.ExtensionRepositoryVersionResourceProvider;
...
public class ControllerModule extends AbstractModule {
  ...
  private void installFactories() {
    ...
    install(new FactoryModuleBuilder()
        ...
        .implement(ResourceProvider.class, Names.named("extensionRepositoryVersion"), ExtensionRepositoryVersionResourceProvider.class)
