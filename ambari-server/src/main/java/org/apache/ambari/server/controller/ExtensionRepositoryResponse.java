...
public class ExtensionRepositoryResponse {
  ...
  public ExtensionRepositoryResponse(String baseUrl, String osType, String repoId,
  ...
  public ExtensionRepositoryResponse(RepositoryInfo repoInfo) {
    setBaseUrl(repoInfo.getBaseUrl());
    setOsType(repoInfo.getOsType());
    setRepoId(repoInfo.getRepoId());
    setRepoName(repoInfo.getRepoName());
    setMirrorsList(repoInfo.getMirrorsList());
    setDefaultBaseUrl(repoInfo.getDefaultBaseUrl());
    setLatestBaseUrl(repoInfo.getLatestBaseUrl());
  }
