...
public class ExtensionRepositoryRequest extends ExtensionOperatingSystemRequest {

  private String repoId;
  private String baseUrl;
  private boolean verify = true;

  public ExtensionRepositoryRequest(String extensionName, String extensionVersion, String osType, String repoId) {
    super(extensionName, extensionVersion, osType);
    setRepoId(repoId);
  }
  ...
  public String toString() {
    return "RepositoryRequest [repoId=" + repoId + ", baseUrl=" + baseUrl
        ...
        + ", getExtensionVersion()=" + getExtensionVersion() + ", getExtensionName()="
        + getExtensionName() + "]";
  }
