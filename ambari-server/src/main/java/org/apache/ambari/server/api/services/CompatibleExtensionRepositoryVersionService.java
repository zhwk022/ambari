 ...
 */
public class CompatibleExtensionRepositoryVersionService extends BaseService {
   ...
   */
  public CompatibleExtensionRepositoryVersionService(Map<Resource.Type, String> parentProperties) {
  ...
  public ExtensionOperatingSystemService getOperatingSystemsHandler(@PathParam("repositoryVersionId") String repositoryVersionId) {
    Map<Resource.Type, String> mapIds = new HashMap<Resource.Type, String>();
    mapIds.putAll(parentKeyProperties);
    mapIds.put(Resource.Type.CompatibleExtensionRepositoryVersion, repositoryVersionId);

    return new ExtensionOperatingSystemService(mapIds);
  }
  ...
  private ResourceInstance createResource(String repositoryVersionId) {
    ...
    return createResource(Resource.Type.CompatibleExtensionRepositoryVersion, mapIds);
  }
}
