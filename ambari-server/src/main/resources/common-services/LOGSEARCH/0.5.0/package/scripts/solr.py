...
class Master(Script):
  ...
  def configure(self, env):
    ...
    File(format("{logsearch_solr_datadir}/solr.xml"), content=xml_content, owner=params.solr_user)    

    log4j_content=InlineTemplate(params.solr_log4j_content)    
    File(format("{logsearch_solr_datadir}/resources/log4j.properties"), content=log4j_content, owner=params.solr_user)    
